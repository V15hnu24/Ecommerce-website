...
create user organizer identified by "organizer@123";

grant drop on * to organizer;
grant select on * to organizer;
grant delete on * to organizer;
grant update on * to organizer;
grant index on * to organizer;
grant insert on * to organizer;
grant delete on * to organizer;
grant drop on * to organizer;
grant trigger on * to organizer;
